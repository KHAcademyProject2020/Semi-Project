...
public class Match {
	...
	public Match(int regist_num, String regist_team, String regist_reservation_code, String regist_status,
			String regist_branch_num, int regist_stadium_num, String team_code, String team_leader, int team_num,
			String team_name, String team_gender, String team_age, String team_region, int team_point,
			String team_mark_img, Date team_active_lastday, String team_delete_status, String reservation_code,
			String reservation_email, String reservation_branch_num, int reservation_stadium_num, int reservation_num,
			int reservation_price, int reservation_usage_start_time, int reservation_usage_time,
			int reservation_usage_end_time, Date reservation_usage_start_date, String reservation_status,
			String branch_num, String branch_manager_email, String branch_address, String branch_phone,
			...
			String branch_option_ball, String branch_option_inout, String branch_delete_status, int stadium_num,
			String stadium_branch_num, String stadium_name, String stadium_match_member,
	...
	public String toString() {
		return "Match [regist_num=" + regist_num + ", regist_team=" + regist_team + ", regist_reservation_code="
				+ regist_reservation_code + ", regist_status=" + regist_status + ", regist_branch_num="
				+ regist_branch_num + ", regist_stadium_num=" + regist_stadium_num + ", team_code=" + team_code
				+ ", team_leader=" + team_leader + ", team_num=" + team_num + ", team_name=" + team_name
				...
				+ team_active_lastday + ", team_delete_status=" + team_delete_status + ", reservation_code="
				+ reservation_code + ", reservation_email=" + reservation_email + ", reservation_branch_num="
				+ reservation_branch_num + ", reservation_stadium_num=" + reservation_stadium_num + ", reservation_num="
				+ reservation_num + ", reservation_price=" + reservation_price + ", reservation_usage_start_time="
				+ reservation_usage_start_time + ", reservation_usage_time=" + reservation_usage_time
				+ ", reservation_usage_end_time=" + reservation_usage_end_time + ", reservation_usage_start_date="
				+ reservation_usage_start_date + ", reservation_status=" + reservation_status + ", branch_num="
				+ branch_num + ", branch_manager_email=" + branch_manager_email + ", branch_address=" + branch_address
				...
				+ ", branch_option_inout=" + branch_option_inout + ", branch_delete_status=" + branch_delete_status
				+ ", stadium_num=" + stadium_num + ", stadium_branch_num=" + stadium_branch_num + ", stadium_name="
				+ stadium_name + ", stadium_match_member=" + stadium_match_member + ", stadium_reservation_start_time="
				+ stadium_reservation_start_time + ", stadium_reservation_end_time=" + stadium_reservation_end_time
				+ ", stadium_delete_status=" + stadium_delete_status + "]";
	}
