...
public class TeamService {
	...
	public void matchRegist(String team_code, String reservation_code, String reservation_branch_num, int reservation_stadium_num) {
		Connection conn = getConnection();
		
		int result = new TeamDAO().matchRegist(conn, team_code, reservation_code, reservation_branch_num, reservation_stadium_num);
	...
	public void matchApplication(String regist_num, String team_code, String branch_num, String stadium_num,
		...
		int result = new TeamDAO().matchApplication(conn, regist_num, team_code, branch_num, stadium_num, reservation_code);
