...
private Properties prop = null;
	...
	public ArrayList<Team> getSelectTeamList(Connection conn, PageInfo pi) {
		...
		try {
			...
			while(rset.next()) {
				Team t = new Team(rset.getString("team_code"),
								rset.getString("team_leader"),
								rset.getInt("team_num"),
								rset.getString("team_name"),
								rset.getString("team_gender"),
	...
	public ArrayList<TeamMemberInfo> selectTeamMember(Connection conn, String team_code, PageInfo pi) {
		...
		try {
			...
			while(rset.next()) {
				TeamMemberInfo = new TeamMemberInfo(rset.getString("supporter_email"),
	...
	public ArrayList<Match> selectMatchList(Connection conn, PageInfo pi) {
		...
		try {
			...
			while(rset.next()) {
				m = new Match(rset.getInt("regist_num"),
									rset.getString("regist_team"),
									rset.getString("regist_reservation_code"),
									rset.getString("regist_status"),
									rset.getString("regist_branch_num"),
									rset.getInt("regist_stadium_num"),
	...
	public ArrayList<MatchApplication> selectMatchApplicationList(Connection conn, String team_code, PageInfo pi) {
		...
		try {
			...
			while(rset.next()) {
				m = new MatchApplication(
									rset.getInt("match_regist_num"),
									rset.getString("match_team"),
									rset.getInt("match_num"),
									rset.getString("match_application_status"),
									rset.getString("match_winlose"),
									rset.getString("manager_point_status"),
									rset.getString("match_branch_num"),
									rset.getInt("match_stadium_num"),
									rset.getString("match_reservation_code"),
									rset.getInt("regist_num"),
									rset.getString("regist_team"),
									rset.getString("regist_reservation_code"),
									rset.getString("regist_status"),
									rset.getString("regist_branch_num"),
