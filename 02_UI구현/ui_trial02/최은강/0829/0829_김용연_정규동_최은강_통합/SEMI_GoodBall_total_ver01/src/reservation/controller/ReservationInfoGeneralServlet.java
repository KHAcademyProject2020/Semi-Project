 ...
 */
@WebServlet("/reservationInfoGaneral.me")
public class ReservationInfoGeneralServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReservationInfoGeneralServlet() {
        super();
...
//		request.setCharacterEncoding("UTF-8");
		...
		String query = "CREATE OR REPLACE VIEW RESERVATIONLIST AS SELECT ROWNUM RNUM, DESCRESERVATION.* FROM (SELECT * FROM RESERVATION JOIN STADIUM ON (RESERVATION_STADIUM_NUM = STADIUM_NUM)";
	    String query2 = " WHERE RESERVATION_EMAIL =" + "'" + userId + "'";
		...
		new ReservationService().createReservationView(query4);
		ArrayList<ReservationInfo> reservationArr = new ReservationService().selectReservationList(pi);
