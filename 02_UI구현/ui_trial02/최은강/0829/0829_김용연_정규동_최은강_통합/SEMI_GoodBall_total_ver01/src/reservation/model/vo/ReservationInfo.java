...
public class ReservationInfo {
	...
	public String toString() {
		return "ReservationInfo [reservation_code=" + reservation_code + ", reservation_email=" + reservation_email
				+ ", reservation_stadium_num=" + reservation_stadium_num + ", reservation_num=" + reservation_num
				+ ", reservation_price=" + reservation_price + ", reservation_usage_start_time="
				...
				+ reservation_usage_start_date + ", reservation_status=" + reservation_status + ", stadium_num="
				+ stadium_num + ", stadium_branch_num=" + stadium_branch_num + ", stadium_name=" + stadium_name
