...
<body>
	...
	<script>
   		$(function(){
   			setInsideVisible1();
   			select(modifyBtn);
            setContent('<object type="text/html" data="<%=request.getContextPath()%>/test_gd/GB_manager_page.html"></object>');
   		});
      ...
      reserveStatusBtn.onclick = e => {
         ...
         setContent('<object type="text/jsp" data="<%=request.getContextPath()%>/test_gd/Manager_Reserve.jsp"></object>');
      };
      
      modifyBtn.onclick = e => {
    	 select(modifyBtn);
         setContent('<object type="text/jsp" data="<%=request.getContextPath()%>/test_gd/Manager_ManagerPage.jsp"></object>');
      };
      
      withdrawBtn.onclick = e => {
         select(withdrawBtn);
         setContent('<object type="text/jsp" data="<%=request.getContextPath()%>/test_gd/Manager_PwdPage.jsp"></object>');
      };
      
      branchListBtn.onclick = e => {
          select(branchListBtn);
          setContent('<object type="text/jsp" data="<%=request.getContextPath()%>/test_gd/Manager_BranchConPage.jsp"></object>');
       };
      
      registBtn.onclick = e => {
          select(registBtn);
          setContent('<object type="text/jsp" data="<%=request.getContextPath()%>/test_gd/Manager_BranchRegPage.jsp"></object>');
       };
   </script>
</body>
</html>