...
public class TeamServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Team> teamArr = new TeamService().selectAll();
		for (int i = 0; i < teamArr.size(); i++) {
			System.out.println(teamArr.get(i));
			
		}
		
		request.setAttribute("teamArr", teamArr);
		RequestDispatcher view = request.getRequestDispatcher("WEB-INF/views/team/teamPage.jsp");
